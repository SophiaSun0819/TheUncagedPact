...
public class FindWindowFrameByName : MonoBehaviour
{
    ...
    private IEnumerator WaitAndSubscribe()
    {
        ...
        GameManager.OnLevel1Complete += SpawnItemsAfterLevel1;
        Debug.Log("[FindWindow] Successfully subscribed to Level1Complete event");
    }

    private void SpawnItemsAfterLevel1()
    {
        Debug.Log("[FindWindow] Level 1 complete! Spawning items...");

        Invoke("SpawnWindow", 1f);
        Invoke("SpawnTable", 1f);
        Invoke("SpawnSoundPuzzle", 1f);
        Invoke("SpawnDrawer", 1f);
        Invoke("CleanupOriginalObjects", 3f);
    }
